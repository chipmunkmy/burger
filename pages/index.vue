<template>
  <div>
    ...
    <div
      id="section-2"
      class="grid grid-cols-3 text-center px-20 py-10 bg-yellow-500 gap-5"
    >
      <div>
        <svg
        ...
        <p class="font-light">
          We use our own secret recipes and only the best ingredients to make our burgers.
      ...
      <div>
        ...
        <p class="font-light">
          ...
          delivery partners from the nearest outlest.
        </p>
      </div>
    </div>

    <div id="section-3" class="text-center">
      <h1 class="text-6xl uppercase font-oswald text-red-600 pt-20 px-24">
        our crazy burgers
      </h1>
      <p class="font-roboto font-light text-gray-500 text-lg py-6 px-20 my-10">
      ...
      <div class="grid grid-cols-2 px-40 gap-5">
        ...
        <div id="right-item-column">
          ...
          <Item
            ...
            title="Double Burger"
            description="2 x beef patties, cheddar cheese, mustard, picles, tomatoes"
            price="15.35"
          />
        </div>
      </div>
    ...
    <div id="section-4" class="px-20 bg-gray-100 py-20">
      <div class="grid grid-cols-2">
        <img src="about.png" alt="" class="pl-20 pr-4 pt-10 leading-snug" />
        <h3 class="font-oswald text-5xl uppercase">
          Nothing Brings People Together like a good burger
        </h3>
      </div>
      <p class="text-lg text-gray-500 mt-10">
        That's the philosophy that we alwasy believe in. We're a family-owned and operated
